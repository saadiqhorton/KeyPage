...
Issue tracking, triage labels, and agent skill packs live outside the public product tree. Do not commit `.cursor/` scratch (except `.cursor/rules/`), `.agents/`, `skills-lock.json`, `docs/plans/`, `docs/agents/`, `docs/evidence/`, or `.odw/` scratch.
